<template>
    <div class="self_description_change" qmanimation_play="|undefined">
        ...
        <div class="self_description">
            <textarea id="selfdescpt" style="width:420px;height:200px">
